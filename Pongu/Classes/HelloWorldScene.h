...
const int BALL_SPEED_UP_LEVELS = 5;
const int COMPUTER_BAR_SPEED_UP_LEVELS = 4;
const int MAX_GAME_LEVEL = BALL_SPEED_UP_LEVELS + COMPUTER_BAR_SPEED_UP_LEVELS;

const float DEFAULT_BALL_SPEED = 1200;
const float MAX_BALL_SPEED = 1500;
const float BALL_SPEED_UP_INTERVAL = (MAX_BALL_SPEED - DEFAULT_BALL_SPEED) / BALL_SPEED_UP_LEVELS;

const float MAX_COMPUTER_BAR_SPEED = DEFAULT_BALL_SPEED * cos(30 * M_PI / 180);
const float DEFAULT_COMPUTER_BAR_SPEED = MAX_COMPUTER_BAR_SPEED - 200;
const float COMPUTER_BAR_SPEED_UP_INTERVAL = (MAX_COMPUTER_BAR_SPEED - DEFAULT_COMPUTER_BAR_SPEED) / COMPUTER_BAR_SPEED_UP_LEVELS;
const float BASE_COMPUTER_BAR_SPEED = DEFAULT_COMPUTER_BAR_SPEED - COMPUTER_BAR_SPEED_UP_INTERVAL;

const float DEFAULT_MY_BAR_SPEED = MAX_COMPUTER_BAR_SPEED;
